        ...
        <div className="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
          ...
          <div className="mt-8 lg:mt-0">
            ...
            <div className="prose prose-blue prose-lg text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
              ...
              <p>As a divorce lawyer in America&#39;s unofficial capital city, Evan&#39;s been lucky to meet fascinating people and work with top experts in fields like finance, trust and estates, real estate, sports, entertainment, psychology, and more. On his podcast <a href="https://podcasts.apple.com/us/podcast/schein-on/id1541360422" target="_blank"><em>Schein On</em></a>, Evan pulls back the curtain and gives an inside and unfiltered look into the world of marriage, money and divorce. He breaks down topics and provides a unique perspective. Schein On will feature guests and leading experts such as sports and entertainment agents, financial advisors, business managers, prominent trust and estate attorneys, therapists and more.</p>
