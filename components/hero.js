export default function Hero() {
  return (
    <section className="mb-16 home-hero lg:relative bg-cyan-700">
      <div className="mx-auto max-w-full w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
        <div className="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
          ...
          <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
            <div className="rounded-md shadow">
              <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-cyan-600 hover:bg-cyan-500 md:py-4 md:text-lg md:px-10">
                Get started
              </a>
            </div>
          </div>
