      ...
      <div className="max-w-7xl mx-auto py-12 px-5 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="md:grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="mb-10">
              <Link
                href="/"
                className="text-gray-400 font-bold text-4xl tracking-tight"
              >
                Evan Schein
              </Link>
            </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            <a
              href="https://www.instagram.com/Scheinonpodcast/"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/evan-schein-32830631/"
              target="_blank"
              className="text-gray-400 hover:text-gray-300"
            >
            ...
            <a
              href="https://twitter.com/evanschein"
              target="_blank"
              className="text-gray-400 hover:text-gray-300"
            >
